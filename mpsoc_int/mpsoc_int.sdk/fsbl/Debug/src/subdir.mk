...
src/psu_init.o: C:/hdl_projects/mpsoc_int/mpsoc_int.sdk/int_hw/psu_init.c
	...
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O0 -g3 -I"C:\hdl_projects\mpsoc_int\mpsoc_int.sdk\int_hw" -c -fmessage-length=0 -MT"$@" -I../../int_bsp/psu_cortexa53_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
