...
targets -set -nocase -filter {name =~"PSU*" && jtag_cable_name =~ "Digilent JTAG-SMT2 210251A1BE22"} -index 1
...
rst -processor
dow C:/hdl_projects/mpsoc_int/mpsoc_int.sdk/power_apu/Debug/power_apu.elf
targets -set -nocase -filter {name =~"MicroBlaze*PMU*" && jtag_cable_name =~ "Digilent JTAG-SMT2 210251A1BE22"} -index 0
catch {stop}
rst -processor
dow C:/hdl_projects/mpsoc_int/mpsoc_int.sdk/test/Debug/test.elf
bpadd -addr &main
