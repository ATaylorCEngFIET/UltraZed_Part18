...
entity design_1_v_tpg_0_0_tpgPatternTartanCDeQ_rom is 
    generic(
             dwidth     : integer := 3; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of design_1_v_tpg_0_0_tpgPatternTartanCDeQ_rom is 
...
entity design_1_v_tpg_0_0_tpgPatternTartanCDeQ is
    generic (
        DataWidth : INTEGER := 3;
...
architecture arch of design_1_v_tpg_0_0_tpgPatternTartanCDeQ is
    component design_1_v_tpg_0_0_tpgPatternTartanCDeQ_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    design_1_v_tpg_0_0_tpgPatternTartanCDeQ_rom_U :  component design_1_v_tpg_0_0_tpgPatternTartanCDeQ_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
